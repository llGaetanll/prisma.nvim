...
return function(config, colors)
	...
	local groups = {
		...
		Normal = config.transparent_mode and { fg = palette.fg1, bg = nil } or { fg = palette.fg1, bg = palette.bg0 },
		...
		Search = { fg = palette.yellow, bg = palette.bg0, reverse = config.inverse },
		IncSearch = { fg = palette.orange, bg = palette.bg0, reverse = config.inverse },
		CurSearch = { link = "IncSearch" },
		QuickFixLine = { fg = palette.bg0, bg = palette.yellow, bold = config.bold },
		...
		WinSeparator = config.transparent_mode and { fg = palette.bg3, bg = nil }
			or { fg = palette.bg3, bg = palette.bg0 },
		...
		SignColumn = config.transparent_mode and { bg = nil } or { bg = palette.bg1 },
		...
		GitSignsAdd = { link = "PrismaGreenSign" },
		GitSignsChange = { link = "PrismaAquaSign" },
		GitSignsDelete = { link = "PrismaRedSign" },
		...
		htmlBold = { fg = palette.fg0, bg = palette.bg0, bold = config.bold },
		htmlBoldUnderline = { fg = palette.fg0, bg = palette.bg0, bold = config.bold, underline = config.underline },
		htmlBoldItalic = { fg = palette.fg0, bg = palette.bg0, bold = config.bold, italic = true },
		...
		htmlUnderline = { fg = palette.fg0, bg = palette.bg0, underline = config.underline },
		htmlUnderlineItalic = {
			fg = palette.fg0,
			bg = palette.bg0,
			italic = true,
		...
		htmlItalic = { fg = palette.fg0, bg = palette.bg0, italic = true },
